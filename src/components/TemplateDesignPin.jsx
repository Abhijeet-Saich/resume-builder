...
import { easeInOut, motion, delay, AnimatePresence } from "framer-motion";
  ...
  return (
    <div>
      <motion.div key={data?._id} {...scaleInOut(index)}>
        <div onClick={handleRouteNavigation}  className="w-full h-[500px] 2xl:h-[740px] rounded-md bg-gray-200 overflow-hidden relative">
          <img
            src={data?.imageURL}
